(function () {
    ...
    function loadTrack(track_index) {
        ...
        document.querySelector(".track-name").textContent = track_list[track_index].title;
        document.querySelector(".composers").textContent = track_list[track_index].composers.join('; ');
